...
function App() {
  ...
  return (
    <>
      <div className={classNames('container', { 'show-nav': showNav })}>
        ...
        <div className="content">
          ...
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus aliquid animi assumenda consequuntur
            ...
            neque officiis pariatur, perspiciatis porro quae quod sapiente sunt voluptatum? Aspernatur autem fuga minus
            perspiciatis recusandae reprehenderit velit? Accusamus ad asperiores fugiat laudantium quae quidem tempore.
            Atque aut corporis delectus error, exercitationem ipsum modi molestias nam obcaecati optio quas, quia
            reiciendis similique. Animi eius in perferendis placeat. Aliquam amet blanditiis corporis cum distinctio,
            eos est eveniet facere, fugit labore molestias nisi perspiciatis possimus quo, quod rem tenetur ut vero
            voluptas voluptatum? Aperiam, dolorum, quo?</p>
          <h3>My Dog</h3>
          <img
